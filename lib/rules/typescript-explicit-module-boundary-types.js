...
const { DefinitionType } = require('@typescript-eslint/scope-manager/dist/definition');
const { isFunction } = require('@typescript-eslint/utils/dist/ast-utils');
const { AST_NODE_TYPES } = require('@typescript-eslint/types/dist');
...
module.exports = {
  ...
  meta: {
    ...
    docs: {
      ...
      url: 'https://github.com/programic/eslint-plugin/blob/master/docs/rules/typescript-explicit-module-boundary-types.md',
    },
    messages: {
