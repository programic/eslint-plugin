...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: 'https://github.com/programic/eslint-plugin/blob/master/docs/rules/vue-computed-property-return-type.md',
    },
  },
  create(context) {
    ...
    function reportComputed(node, computedName, type = null) {
