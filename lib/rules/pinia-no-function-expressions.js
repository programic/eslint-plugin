...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: 'https://github.com/programic/eslint-plugin/blob/master/docs/src/rules/pinia-no-function-variable-declarations.md',
    },
  },
  create(context) {
    return {
            ...
            if (isFunctionNode(storeDefinerNode) && Array.isArray(storeDefinerNode?.body?.body)) {
              ...
              functionExpressionNodes.forEach(functionExpressionNode => {
                context.report({
                  ...
                  message: 'Function expression is forbidden when it\'s a direct child of Pinia store setup definition',
                });
              });
            }
          }
